  ...
  module Helpers
    ...
    private
      def display_time_in_words(hash, options = {})
        ...
        options[:words_connector] ||= I18n.translate(:'datetime.dotiw.words_connector', :default => :'support.array.words_connector', :locale => options[:locale])
        options[:two_words_connector] ||= I18n.translate(:'datetime.dotiw.two_words_connector', :default => :'support.array.two_words_connector', :locale => options[:locale])
        options[:last_word_connector] ||= I18n.translate(:'datetime.dotiw.last_word_connector', :default => :'support.array.last_word_connector', :locale => options[:locale])
